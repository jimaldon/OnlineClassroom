...
<body>
	...
	<div id="port" class="portfolio portfolio-box">
		<div class="container">
			<h3>User Profile - Admin Access Control</h3>
			<!----start-portfolio---->
			<br>
					...
					<div id="port" class="container portfolio-main">
						<table>
							<tr>
								...
								<td class="td"><input type="text" name="loginName"
									value="${profile.loginName }" readonly style="width: 392.22222px;" /></td>
							</tr>
							<tr>
								<td class="td">Password</td>
								<td class="td"><input type="text" name="password"
									value="${profile.password }" style="width: 392.22222px;" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="td"><textarea
										style="margin: 0px; width: 391px; height: 89px;"
										name="city">${profile.city }</textarea>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="td"><input type="text" name="typeOfUser" value="${profile.typeOfUser }"
									style="width: 392.22222px;" /></td>
							</tr>
							<tr>
								<td class="td">Is Deleted</td>
								<td class="td"><input type="text" name="isDeleted" value="${profile.isDeleted }"
									style="width: 392.22222px;" /></td>
							</tr>
							<tr>
